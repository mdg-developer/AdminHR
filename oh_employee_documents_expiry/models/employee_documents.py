...
class HrEmployeeDocument(models.Model):
    ...
    company_id = fields.Many2one('res.company', related='employee_ref.company_id', store=True,string="Company")
    branch_id = fields.Many2one('res.branch', related='employee_ref.branch_id', store=True,
                                string='Branch',
                                readonly=True)
    department_id = fields.Many2one('hr.department', related='employee_ref.department_id', store=True,
                                    string='Department',
                                    readonly=True)
    def action_send_to_employee(self):
        self.state = 'send_to_employee'
