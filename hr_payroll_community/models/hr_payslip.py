...
class HrPayslip(models.Model):
    ...
    def action_payslip_done(self):
        ...
        # loan_obj = self.env['hr.loan'].search([('company_id', '=', self.company_id.id), ('employee_id', '=', self.employee_id.id)])
        # if loan_obj:
        #     for line in loan_obj.loan_lines:
        #         if line.date >= self.date_from and line.date <= self.date_to:
